...
export type ReflectElementMouseEvents =
    'mousemove'
    | 'mouseleave'
    | 'mouseup'
    | 'mousedown'
...
export type ReflectElementModelAllowedPropsValues = string | number | ReflectPointArray2d

export interface ReflectElementModelScheme {
    [key: string]: ReflectElementModelAllowedPropsValues
}
