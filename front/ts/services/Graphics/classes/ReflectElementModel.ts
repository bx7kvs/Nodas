...
import {ReflectElementModelAllowedPropsValues, ReflectElementModelScheme} from "../@types/types";

export default class ReflectElementModel<Props extends ReflectElementModelScheme, Element extends ReflectElement<any>> {
    ...
    style(styles: Partial<Props>): Element
    style<Prop extends keyof Props>(prop: Prop, value: Props[Prop]): Element
    style<Prop extends keyof Props>(prop: Prop): Props[Prop]
    style<Prop extends keyof Props>(prop: Prop | Partial<Props>, value?: Props[Prop]) {
        if (typeof prop === "object"){
            (Object.keys(prop) as Array<Prop>).forEach(
                (v) => {
                    if(v in this.props) {
                        this.props[v] = prop[v]
                    }
...
//     this
// .
//     define = function (ordering, name, value, setter, getter) {
//         if (properties[name]) {
