                                ...
                                if (value[i]) {
                                    if (ModelHelper.validNumericArray(value[i]) && value[i].length == 2) {
                                        ...
                                        Debug.warn({
                                            i: i,
                                            val: value[i]
                                        }, '[{i}][{val}] is not a valid bgposition value');
                                    }
                                }
                                else {
                                    if (bgposition[i]) {
...
$R.service.class('Objects',
    ['@extend',
        function GroupObjectModel(extend) {
...
$R.service.class('Objects',
    ['@extend', 'Debug',
        function ImageObjectModel(extend, Debug) {
